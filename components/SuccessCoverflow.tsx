...
export default function SuccessCoverflow({
    items,
    height = 420,
    autoplayMs = 2600,
    className = "",
        ...
        <div className={`relative ${className}`}>
            <div className="mx-auto max-w-[1248px] px-2 py-4">
                ...
                <Swiper
                    ...
                    centeredSlides
                    loop
                    autoplay={{ delay: autoplayMs, disableOnInteraction: false, pauseOnMouseEnter: true }}
                    grabCursor
                    slidesPerView={1.15}
                    spaceBetween={16}
                    coverflowEffect={{
                    ...
                    breakpoints={{
                        ...
                        820: { slidesPerView: 2.2, spaceBetween: 20 },
                ...
                >
                    {pool.map(({ src, caption }, i) => (
                        <SwiperSlide key={`${src}-${i}`} style={{ width: cardW }}>
                            <button
            ...
            <AnimatePresence>
                {open && (
                    ...
                    >
                        <motion.div
                            initial={{ scale: 0.97 }} animate={{ scale: 1 }} exit={{ scale: 0.98 }}
...
export function SuccessHeroSlider({
    items,
    height = 560,
    autoplayMs = 2200,
    className = "",
